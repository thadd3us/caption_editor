...
export default defineComponent({
  ...
  props: {
    params: {
      type: Object as () => ICellEditorParams,
      required: true
    }
  },
  setup(props) {
    ...
    console.log('[SpeakerNameCellEditor] Returning from setup() with exposed methods')

    // Return everything that needs to be accessible (template and AG Grid)
    return {
      // Template refs and data
      inputRef,
      editValue,
      datalistId,
      filteredSpeakers,
